        ...
        <div class ="row">
            ...
            <div class="col-md-6">
                <div class = "title2">
                    ...
                    <div class = "row">
                        <div class = "col-md-6">
                            <input type="text" class = "form-control " id = "pS_Time" name="pS_Time" style="border-radius: 0px;" placeholder="몇시 부터 ex)09:00" >
                        </div>
                        <div class = "col-md-6">
                            <input type="text" class = "form-control " id = "pE_Time" name="pE_Time" style="border-radius: 0px;" placeholder="몇시 까지 ex)21:00 " >
                        </div>
